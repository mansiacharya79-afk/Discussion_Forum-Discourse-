    ...
    <nav className="bar sticky top-0 z-[100]">
      <div className="bar-in">
        ...
        <div className="bar-links" role="navigation" aria-label="Primary">
          <button className={`bar-link-btn ${currentView === 'posts' ? 'on' : ''}`} onClick={onPostsPage}>Posts</button>
          <button className={`bar-link-btn ${currentView === 'topics' ? 'on' : ''}`} onClick={onTopicPage}>Topics</button>
